...
const TOPOLOGY = [
  ...
  { id: "gw-west", type: "router", x: 0.18, y: 0.2, label: "GW" },
  { id: "sw-west", type: "switch", x: 0.24, y: 0.42, label: "SW" },
  ...
  { id: "fw-core", type: "firewall", x: 0.28, y: 0.24, label: "FW" },
  { id: "rt-core-a", type: "router", x: 0.82, y: 0.78, label: "R1" },
  ...
  { id: "sw-east", type: "switch", x: 0.74, y: 0.58, label: "SW" },
